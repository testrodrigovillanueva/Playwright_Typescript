...
vid="C:/Users/Rodrigo/Documents/VIDEOS_UDEMY_ES/PLAYWRIGHT_TYPESCRIPT_CURSO/tests/archivos/vid"+ranp+".png"
...
test.describe('Combo Box', () => {
  ...
  test.skip('Upload files Uno', async () => {
  ...
  test.skip('Upload files Dos', async () => {
    await f.scroll(0,1000)
    await f.tiempo(tg)
    await f.Upload_file("//input[contains(@id,'wsf-1-field-94')]",archivo,tg)
    await f.Mover_Upload_file("//input[contains(@id,'wsf-1-field-94')]",tg)
